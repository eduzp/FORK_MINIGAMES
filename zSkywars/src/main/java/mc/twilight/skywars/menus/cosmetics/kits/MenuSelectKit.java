...
public class MenuSelectKit<T extends Kit> extends PagedPlayerMenu {
  ...
  public MenuSelectKit(Profile profile, Class<T> cosmeticClass) {
    super(profile.getPlayer(), "Kits", 6);
            ...
            if (evt.getSlot() == this.previousPage) {
              ...
              if (cosmetic != null) {
                ...
                if (cosmetic.isSelected(profile)) {
                  profile.getAbstractContainer("zCoreSkyWars", "selected", SelectedContainer.class).setSelected(cosmetic.getType(), 0);
                } else {
                  profile.getAbstractContainer("zCoreSkyWars", "selected", SelectedContainer.class).setSelected(cosmetic);
                }
