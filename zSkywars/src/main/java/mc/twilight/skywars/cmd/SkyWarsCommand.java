...
import mc.twilight.skywars.cmd.sw.*;
...
public class SkyWarsCommand extends Commands {
  ...
  public void perform(CommandSender sender, String label, String[] args) {
    if (!sender.hasPermission("zskywars.cmd.skywars")) {
      sender.sendMessage("§6zSkyWars §bv" + Main.getInstance().getDescription().getVersion() + " §7Feito por eduzp.");
      return;
    }
