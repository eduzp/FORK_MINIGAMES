package mc.twilight.skywars.nms;

import mc.twilight.core.reflection.Accessors;
import mc.twilight.core.reflection.acessors.FieldAccessor;
import mc.twilight.skywars.nms.entity.*;
import mc.twilight.skywars.nms.interfaces.BalloonEntity;
...
public class NMS {
  ...
  public static Entity createAttachedCart(String owner, Location location) {
    ...
    mc.twilight.core.nms.NMS.look(cart.getBukkitEntity(), location.getYaw(), location.getPitch());
