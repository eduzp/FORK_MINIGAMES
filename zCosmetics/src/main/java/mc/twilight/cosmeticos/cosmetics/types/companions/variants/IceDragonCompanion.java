...
public class IceDragonCompanion extends CompanionCosmetic {
  
  public IceDragonCompanion() {
    super("Dragão de Gelo", 5, EnumRarity.DIVINO,
        "SKULL_ITEM:3 : 1 : nome>Dragão de Gelo : desc>&7Divirta-se pelos nossos lobbies\n&7acompanhado de um Dragão de Gelo! : skin>eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWNkY2VjZmY0ZjZiYTBiMjQ2Zjc3NzU3NTNkNzkxZjE2YzljNmRlNTUzNWQ3OTUyMzZhNGYzYzhjOWIyOTNiIn19fQ==");
  ...
  public CompanionNames getNameEnum() {
    return CompanionNames.ICEDRAGON;
  }
}
