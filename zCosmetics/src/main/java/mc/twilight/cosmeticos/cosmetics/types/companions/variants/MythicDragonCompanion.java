...
public class MythicDragonCompanion extends CompanionCosmetic {
  
  public MythicDragonCompanion() {
    super("Dragão Mítico", 5, EnumRarity.DIVINO,
        "SKULL_ITEM:3 : 1 : nome>Dragão Mítico : desc>&7Divirta-se pelos nossos lobbies\n&7acompanhado de um Dragão Mítico! : skin>eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWMyMGZiYmUxNWQ2ZTU5NDZmOTUyYmMxYjA3NDQ4NmRkMzNlNDZiMjM2MWY3Y2Y2YjBkYTU5MzIzMDc0NCJ9fX0=");
  ...
  public CompanionNames getNameEnum() {
    return CompanionNames.MYTHICDRAGON;
  }
}
