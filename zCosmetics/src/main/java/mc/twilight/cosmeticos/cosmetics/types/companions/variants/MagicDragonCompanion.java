...
public class MagicDragonCompanion extends CompanionCosmetic {
  
  public MagicDragonCompanion() {
    super("Dragão Mágico", 5, EnumRarity.DIVINO,
        "SKULL_ITEM:3 : 1 : nome>Dragão Mágico : desc>&7Divirta-se pelos nossos lobbies\n&7acompanhado de um Dragão Mágico! : skin>eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzA2ZjQ3ZDNiNzUxNTdjNDU1Njk0MjE2YWU0OGM0NjE5ZGJkNTZjMTMxOWFiYTdiYTY2OWU0NTQxMDkwIn19fQ==");
  ...
  public CompanionNames getNameEnum() {
    return CompanionNames.MAGICDRAGON;
  }
}
