...
public class FireDragonEntity extends CompanionSlime {
  ...
  public FireDragonEntity(Companion companion) {
    super(companion);
    ...
    l_leg_b.getStand().setItemInHand(BukkitUtils.deserializeItemStack("CARPET:14 : 1"));
    ...
    l_horn.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:14 : 1"));
    ...
    l_wing6.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    r_horn.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:14 : 1"));
    
    CompanionStructure body2 = this.buildPart("body2", new RelativeLocation(0.3, 0.0, -0.35), false);
    body2.getStand().setHelmet(BukkitUtils.deserializeItemStack("WOOL:14 : 1"));
    ...
    l_wing1.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    back.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:14 : 1"));
    
    CompanionStructure body = this.buildPart("body", new RelativeLocation(0.3, 0.0, 0.2), false);
    body.getStand().setHelmet(BukkitUtils.deserializeItemStack("WOOL:14 : 1"));
    ...
    l_wing5.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    l_wing4.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    l_wing3.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    l_wing2.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    head.getStand().setHelmet(BukkitUtils.deserializeItemStack(
        "SKULL_ITEM:3 : 1 : skin>eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGIzNmQ3OWJhNDA3MDUzYzI1MWJkNGFhOTEzYTVlMjgxY2NkMjRkOGQ5ZWJlOTNkMjhiYjYyZjE0MGFkYzUifX19"));
    ...
    r_wing1.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    r_wing3.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    r_wing2.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    r_wing5.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
    ...
    r_wing4.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:1 : 1"));
