...
public class IceDragonEntity extends CompanionSlime {
  
  public IceDragonEntity(Companion companion) {
    super(companion);
    ...
    l_leg_b.getStand().setItemInHand(BukkitUtils.deserializeItemStack("CARPET:15 : 1"));
    ...
    l_horn.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:15 : 1"));
    ...
    r_horn.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:15 : 1"));
    
    CompanionStructure body2 = this.buildPart("body2", new RelativeLocation(0.3, 0.0, -0.35), false);
    body2.getStand().setHelmet(BukkitUtils.deserializeItemStack("WOOL:3 : 1"));
    ...
    back.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:15 : 1"));
    
    CompanionStructure body = this.buildPart("body", new RelativeLocation(0.3, 0.0, 0.2), false);
    body.getStand().setHelmet(BukkitUtils.deserializeItemStack("WOOL:3 : 1"));
    ...
    head.getStand().setHelmet(BukkitUtils.deserializeItemStack("SKULL_ITEM:3 : 1 : skin>eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWNkY2VjZmY0ZjZiYTBiMjQ2Zjc3NzU3NTNkNzkxZjE2YzljNmRlNTUzNWQ3OTUyMzZhNGYzYzhjOWIyOTNiIn19fQ=="));
