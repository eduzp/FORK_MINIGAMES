...
public class MagicDragonEntity extends CompanionSlime {
  
  public MagicDragonEntity(Companion companion) {
    super(companion);
    ...
    l_leg_b.getStand().setItemInHand(BukkitUtils.deserializeItemStack("CARPET:4 : 1"));
    ...
    l_horn.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:4 : 1"));
    ...
    l_wing6.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    r_horn.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:4 : 1"));
    
    CompanionStructure body2 = this.buildPart("body2", new RelativeLocation(0.3, 0.0, -0.35), false);
    body2.getStand().setHelmet(BukkitUtils.deserializeItemStack("WOOL:10 : 1"));
    ...
    l_wing1.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    back.getStand().setHelmet(BukkitUtils.deserializeItemStack("CARPET:4 : 1"));
    
    CompanionStructure body = this.buildPart("body", new RelativeLocation(0.3, 0.0, 0.2), false);
    body.getStand().setHelmet(BukkitUtils.deserializeItemStack("WOOL:10 : 1"));
    ...
    l_wing5.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    l_wing4.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    l_wing3.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    l_wing2.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    
    CompanionStructure head = this.buildPart("head", new RelativeLocation(0.4, 0.0, 0.5), false);
    head.getStand().setHelmet(BukkitUtils.deserializeItemStack("SKULL_ITEM:3 : 1 : skin>eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzA2ZjQ3ZDNiNzUxNTdjNDU1Njk0MjE2YWU0OGM0NjE5ZGJkNTZjMTMxOWFiYTdiYTY2OWU0NTQxMDkwIn19fQ=="));
    ...
    r_wing1.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    r_wing3.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    r_wing2.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    r_wing5.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
    ...
    r_wing4.getStand().setHelmet(BukkitUtils.deserializeItemStack("BANNER:5 : 1"));
