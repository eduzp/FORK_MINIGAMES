...
public enum Sound {
   ...
   FIRE_IGNITE("FIRE_IGNITE", "BLOCK_FIRE_EXTINGUISH"),
   ...
   STEP_WOOL("STEP_WOOL", "BLOCK_SNOW_STEP"),
   SWIM("SWIM", "ENTITY_PLAYER_SWIM"),
   WATER("WATER", "BLOCK_WATER_AMBIENT"),
   WOOD_CLICK("WOOD_CLICK", "BLOCK_STONE_BUTTON_CLICK_ON"),
   ...
   CREEPER_HISS("CREEPER_HISS", "ENTITY_CREEPER_HURT"),
   ...
   SLIME_WALK("SLIME_WALK", "ENTITY_SLIME_SQUISH"),
   SLIME_WALK2("SLIME_WALK2", "ENTITY_SMALL_SLIME_SQUISH"),
   ...
   ZOMBIE_UNFECT("ZOMBIE_UNFECT", "ENTITY_ZOMBIE_VILLAGER_CURE"),
   ZOMBIE_REMEDY("ZOMBIE_REMEDY", "ENTITY_ZOMBIE_VILLAGER_CONVERTED"),
   ...
   private Sound(String oldSound, String newSound) {
   ...
   public org.bukkit.Sound getSound() {
      ...
      if (localSound == null) {
         Core.LOGGER.log(Level.WARNING, "SOM \"" + this.name() + "\" esta null!");
      }
