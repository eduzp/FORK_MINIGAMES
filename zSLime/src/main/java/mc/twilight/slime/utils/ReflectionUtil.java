package mc.twilight.slime.utils;
...
public class ReflectionUtil {
     ...
     * target class with the specified name and package cannot be found
     ...
     * match the parameter types of the constructor (this should not occur since
     * it searches for a constructor with the types of the arguments)
     ...
     * class with the specified name and parameter types cannot be found
     * @throws ClassNotFoundException If the desired target class with the
     * specified name and package cannot be found
     * @see #getClass(String, PackageType)
     ...
     * @throws IllegalArgumentException If the types of the arguments do not
     * match the parameter types of the method (this should not occur since it
     * searches for a method with the types of the arguments)
     ...
     * target object with the specified name and arguments cannot be found
     * @see #getMethod(Class, String, Class...)
     ...
     * @return The value of field of the target object
     * @throws IllegalArgumentException If the target object does not feature
     * the desired field (should not occur since it searches for a field with
     * the given name in the class of the object)
     * @throws IllegalAccessException If the desired field cannot be accessed
