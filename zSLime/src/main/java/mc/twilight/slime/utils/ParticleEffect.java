...
import mc.twilight.slime.utils.ReflectionUtil.PackageType;
...
public enum ParticleEffect {
     ...
     * directional or if it requires water and none is at the center location
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                playerConnection = ReflectionUtil.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
                sendPacket = ReflectionUtil.getMethod(playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    if (data != null) {
                        ...
                        ReflectionUtil.setValue(packet, true, "k", effect == ParticleEffect.ITEM_CRACK ? packetData : new int[]{packetData[0] | (packetData[1] << 12)});
                    }
                }
         ...
         * range for particles is usually 16, but it can differ for some types)
