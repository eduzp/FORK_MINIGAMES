package mc.twilight.core.nms.v1_8_R3;
...
import mc.twilight.core.libraries.npclib.api.npc.NPCAnimation;
import mc.twilight.core.libraries.npclib.npc.EntityControllers;
...
import mc.twilight.core.nms.interfaces.INMS;
import mc.twilight.core.nms.interfaces.entity.IArmorStand;
import mc.twilight.core.nms.interfaces.entity.IItem;
import mc.twilight.core.nms.interfaces.entity.ISlime;
import mc.twilight.core.nms.v1_8_R3.entity.EntityItem;
import mc.twilight.core.nms.v1_8_R3.entity.EntityNPCPlayer;
import mc.twilight.core.nms.v1_8_R3.entity.EntitySlime;
import mc.twilight.core.nms.v1_8_R3.entity.EntityStand;
import mc.twilight.core.nms.v1_8_R3.entity.HumanController;
import mc.twilight.core.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import mc.twilight.core.nms.v1_8_R3.utils.UUIDMetadataStore;
import mc.twilight.core.reflection.Accessors;
import mc.twilight.core.nms.v1_8_R3.entity.EntityArmorStand;
import mc.twilight.core.reflection.acessors.FieldAccessor;
import mc.twilight.core.utils.Utils;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_NAME.get(null).put(EntityStand.class, "zCore-EntityStand");
    CLASS_TO_ID.get(null).put(EntityArmorStand.class, 30);
    CLASS_TO_NAME.get(null).put(EntityArmorStand.class, "zCore-ArmorStand");
    CLASS_TO_ID.get(null).put(EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(EntitySlime.class, "zCore-Slime");
    CLASS_TO_ID.get(null).put(EntityItem.class, 1);
    CLASS_TO_NAME.get(null).put(EntityItem.class, "zCore-Item");
