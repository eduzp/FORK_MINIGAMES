package mc.twilight.core.nms.v1_8_R3.utils;

import mc.twilight.core.nms.v1_8_R3.entity.EntityNPCPlayer;
import mc.twilight.core.nms.v1_8_R3.utils.pathfinding.PlayerPathfinder;
import mc.twilight.core.nms.v1_8_R3.utils.pathfinding.PlayerPathfinderNormal;
...
public class PlayerNavigation extends NavigationAbstract {
  ...
  public void k() {
    ...
    AxisAlignedBB localObject = new AxisAlignedBB(localVec3D.a, localVec3D.b, localVec3D.c, localVec3D.a, localVec3D.b,
    ...
    for (AxisAlignedBB localAxisAlignedBB : localList) {
      d1 = localAxisAlignedBB.b(localObject, d1);
    }
