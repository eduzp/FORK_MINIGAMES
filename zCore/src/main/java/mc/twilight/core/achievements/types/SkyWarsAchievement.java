...
public class SkyWarsAchievement extends Achievement {
  ...
  protected boolean check(Profile profile) {
    return profile.getStats("zCoreSkyWars", this.stats) >= this.reach;
  }
  
  public ItemStack getIcon(Profile profile) {
    long current = profile.getStats("zCoreSkyWars", this.stats);
  ...
  static class CoinsReward implements SkyWarsReward {
    ...
    public void give(Profile profile) {
      profile.getDataContainer("zCoreSkyWars", "coins").addDouble(this.amount);
    }
  }
