...
public class BedWarsAchievement extends Achievement {
  ...
  protected boolean check(Profile profile) {
    return profile.getStats("zCoreBedWars", this.stats) >= this.reach;
  }
  
  public ItemStack getIcon(Profile profile) {
    long current = profile.getStats("zCoreBedWars", this.stats);
  ...
  static class CoinsReward implements BedWarsReward {
    ...
    public void give(Profile profile) {
      profile.getDataContainer("zCoreBedWars", "coins").addDouble(this.amount);
    }
  }
