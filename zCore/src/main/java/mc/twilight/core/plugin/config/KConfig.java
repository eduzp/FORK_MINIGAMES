package mc.twilight.core.plugin.config;
...
public class KConfig {
  ...
  public static KConfig getConfig(KPlugin plugin, String path, String name) {
    if (!cache.containsKey(path + "/" + name)) {
      cache.put(path + "/" + name, new KConfig(plugin, path, name));
    }
