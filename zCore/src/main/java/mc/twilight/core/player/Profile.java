...
import mc.twilight.core.hook.FriendsHook;
import mc.twilight.core.player.enums.PlayerVisibility;
...
public class Profile {
  ...
  public Profile(String name) throws ProfileLoadException {
    ...
    this.getDataContainer("zCoreProfile", "lastlogin").set(System.currentTimeMillis());
  }
  ...
  public void refresh() {
    ...
    if (!playingGame()) {
      ...
      this.getDataContainer("zCoreProfile", "role").set(StringUtils.stripColors(Role.getPlayerRole(player, true).getName()));
    }
  ...
  public SkinsContainer getSkinListContainer() {
    return this.getAbstractContainer("Skins", "skins", SkinsContainer.class);
  }
  ...
  public DeliveriesContainer getDeliveriesContainer() {
    return this.getAbstractContainer("zCoreProfile", "deliveries", DeliveriesContainer.class);
  }

  public PreferencesContainer getPreferencesContainer() {
    return this.getAbstractContainer("zCoreProfile", "preferences", PreferencesContainer.class);
  }
  
  public TitlesContainer getTitlesContainer() {
    return this.getAbstractContainer("zCoreProfile", "titles", TitlesContainer.class);
  }
  
  public BoostersContainer getBoostersContainer() {
    return this.getAbstractContainer("zCoreProfile", "boosters", BoostersContainer.class);
  }
  
  public AchievementsContainer getAchievementsContainer() {
    return this.getAbstractContainer("zCoreProfile", "achievements", AchievementsContainer.class);
  }
  
  public SelectedContainer getSelectedContainer() {
    return this.getAbstractContainer("zCoreProfile", "selected", SelectedContainer.class);
  }
