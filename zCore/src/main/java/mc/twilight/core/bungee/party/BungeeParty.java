package mc.twilight.core.bungee.party;
...
import static mc.twilight.core.party.PartyRole.LEADER;
...
public class BungeeParty extends Party {
  ...
  private void sendData(String extraKey, String extraValue, Collection<ServerInfo> serverInfos) {
    ...
    serverInfos.forEach(info -> info.sendData("zCore", out.toByteArray()));
  }
