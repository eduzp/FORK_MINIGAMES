package mc.twilight.core.bungee.listener;

import com.google.common.io.ByteArrayDataInput;
import com.google.common.io.ByteArrayDataOutput;
import com.google.common.io.ByteStreams;
import mc.twilight.core.bungee.Bungee;
import mc.twilight.core.bungee.party.BungeeParty;
import mc.twilight.core.bungee.party.BungeePartyManager;
...
public class Listeners implements Listener {
  ...
  public void onPluginMessage(PluginMessageEvent evt) {
    if (evt.getSender() instanceof ServerConnection && evt.getReceiver() instanceof ProxiedPlayer) {
      if (evt.getTag().equalsIgnoreCase("zCore")) {
        ...
        if (subChannel.equalsIgnoreCase("FAKE_SKIN")) {
          ...
          if (profile != null) {
            try {
              ...
              // Handle the exception as needed without using PROPERTY_BACKUP
            }
          }
        }
      }
  ...
  public void onServerConnected(ServerConnectedEvent evt) {
    ...
    if (Bungee.isFake(player.getName())) {
      ...
      out.writeUTF(skin);
      evt.getServer().sendData("zCore", out.toByteArray());
