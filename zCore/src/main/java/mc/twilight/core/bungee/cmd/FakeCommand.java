package mc.twilight.core.bungee.cmd;
...
import static mc.twilight.core.bungee.Bungee.ALEX;
import static mc.twilight.core.bungee.Bungee.STEVE;
...
public class FakeCommand extends Commands {
  ...
  public void perform(CommandSender sender, String[] args) {
    ...
    if (!player.hasPermission("zCore.cmd.fake")) {
