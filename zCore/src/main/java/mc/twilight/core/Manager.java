...
import mc.twilight.core.bungee.Bungee;
...
public class Manager {
  ...
  static {
    try {
      ...
      Class<?> bungeeMain = Class.forName("mc.twilight.core.bungee.Bungee");
      ...
      try {
        ...
        Class<?> fakeManager = Class.forName("mc.twilight.core.player.fake.FakeManager");
        GET_NAME = Accessors.getMethod(player, "getName");
        GET_PLAYER = Accessors.getMethod(Class.forName("mc.twilight.core.player.Profile"), "findCached", String.class);
